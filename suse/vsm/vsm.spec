...
install -p -D -m 755 usr/lib/systemd/system/vsm-physical.service %{buildroot}%{_unitdir}/vsm-physical.service
install -p -D -m 755 usr/lib/systemd/system/vsm-agent.service %{buildroot}%{_unitdir}/vsm-agent.service
install -p -D -m 755 usr/lib/systemd/system/vsm-api.service %{buildroot}%{_unitdir}/vsm-api.service
install -p -D -m 755 usr/lib/systemd/system/vsm-conductor.service %{buildroot}%{_unitdir}/vsm-conductor.service
install -p -D -m 755 usr/lib/systemd/system/vsm-scheduler.service %{buildroot}%{_unitdir}/vsm-scheduler.service

install -m 0644 -D usr/lib/systemd/system/vsm.tmpfiles.d %{buildroot}/%{_tmpfilesdir}/%{name}.conf
