...
DATABASES = {
    'default': {
        ...
        'NAME': '%MYSQL_VSM_DASHBOARD_DATABASE%',
        'USER': '%MYSQL_VSM_DASHBOARD_USER_NAME%',
        'PASSWORD': '%MYSQL_VSM_DASHBOARD_PASSWORD%',
        'HOST': '%MYSQL_HOST%',
...
KEYSTONE_VSM_SERVICE_PASSWORD = "%KEYSTONE_VSM_SERVICE_PASSWORD%"
