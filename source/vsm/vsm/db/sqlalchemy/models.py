...
class Device(BASE, VsmBase):
    ...
    total_capacity_kb = Column(Integer, default=0, nullable=False)
    used_capacity_kb = Column(Integer, default=0, nullable=False)
    avail_capacity_kb = Column(Integer, default=0, nullable=False)
