...
*	Create, Attach, Delete Hardware (Block Store)
...
Type declarations
-----------------
*	Data declarations – Hardwares and Objects
...
These additional parameters would also apply to creation of block storage storages (along with the existing parameter of ‘size’), and creation of object storage ‘buckets’. (C.I.A. classifications on a bucket would be inherited by the keys within this bucket.)
...
A hybrid cloud environment provides dedicated, potentially co-located physical storage with a network interconnect to the project or users’ cloud virtual network.
...
*	Total number of storages (user / project)
*	Maximum size of storage
*	Cumulative size of all storages
