...
It usually makes sense to define an Abstract Base Class for the specific driver (i.e. HardwareDriver), to define the methods that a different driver would need to implement.
