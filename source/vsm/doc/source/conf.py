...
# -*- coding: utf-8 -*-
#
# vsm documentation build configuration file, created by
...
# built documents.
#
from vsm.version import version_info
...
man_pages = [
    ('man/vsm-manage', 'vsm-manage', u'Cloud controller fabric',
     [u'OpenStack'], 1)
]
