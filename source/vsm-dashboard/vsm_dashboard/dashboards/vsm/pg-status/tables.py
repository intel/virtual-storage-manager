...
class ListPGStatusTable(tables.DataTable):
    STATUS_CHOICES = (
        ("active", True),
        ("available", True),
        ("Active", True),
    ...
    pg_id = tables.Column("pg_id", verbose_name=_("PG ID"))
    state = tables.Column("state", verbose_name=_("State"))
    up = tables.Column("up", verbose_name=_("Up"))
    acting = tables.Column("acting", verbose_name=_("Acting"))

    class Meta:
        name = "pg_list"
        verbose_name = _("PG List")
