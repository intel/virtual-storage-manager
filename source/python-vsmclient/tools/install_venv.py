...
def install_dependencies(venv=VENV):
    ...
    # Tell the virtual env how to "import vsm"
...
def print_help():
    help = """
    python-vsmclient development environment setup is complete.

    python-vsmclient development uses virtualenv to track and manage Python
    dependencies while in development and testing.

    To activate the python-vsmclient virtualenv for the extent of your
