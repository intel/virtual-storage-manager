...
DEFAULT_VSM_ENDPOINT_TYPE = 'publicURL'
DEFAULT_VSM_SERVICE_TYPE = 'compute'
...
class OpenStackVsmShell(object):
    ...
    def _discover_extensions(self, version):
        ...
        for name, module in itertools.chain(
            ...
            extension = vsmclient.extension.Extension(name, module)
    ...
    def _discover_via_python_path(self, version):
        for (module_loader, name, ispkg) in pkgutil.iter_modules():
            if name.endswith('python_vsmclient_ext'):
    ...
    def main(self, argv):
        ...
        (os_username, os_password, os_tenant_name, os_auth_url,
         ...
         service_type, service_name, vsm_service_name,
         username, apikey, projectid, url, region_name, cacert) = (
             ...
             args.vsm_service_name, args.username,
             args.apikey, args.projectid,
             args.url, args.region_name, args.os_cacert)

        if not endpoint_type:
            endpoint_type = DEFAULT_VSM_ENDPOINT_TYPE

        if not service_type:
            service_type = DEFAULT_VSM_SERVICE_TYPE
        ...
        self.cs = client.Client(options.os_vsm_api_version, os_username,
    ...
    def do_bash_completion(self, args):
        ...
        vsm.bash_completion script doesn't have to hard code them.
        """
        commands = set()
        options = set()
...
def main():
    try:
        ...
        print >> sys.stderr, "... terminating vsm client"
        sys.exit(130)
    except Exception, e:
