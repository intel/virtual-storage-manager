...
from vsmclient.v2 import client
from tests import fakes
import tests.utils as utils

def _stub_vsm(**kwargs):
    vsm = {
        'id': '1234',
        'name': None,
        'description': None,
        ...
        "links": [
            {
                "href": "http://localhost/v2/fake/vsms/1234",
                "rel": "self"
            },
            {
                "href": "http://localhost/fake/vsms/1234",
                "rel": "bookmark"
            }
        ],
    }
...
def _stub_snapshot(**kwargs):
    snapshot = {
        ...
        "size": 1,
        "status": "available",
        "vsm_id": '00000000-0000-0000-0000-000000000000',
    }
...
def _stub_backup_full(id, base_uri, tenant_id):
    return {
        ...
        'vsm_id': '712f4980-5ac1-41e5-9383-390aa7c9f58b',
        'container': 'vsmbackups',
        'object_count': 220,
        'size': 10,
...
def _stub_restore():
    return {'vsm_id': '712f4980-5ac1-41e5-9383-390aa7c9f58b'}
...
class FakeHTTPClient(base_client.HTTPClient):
    ...
    def put_vsms_1234(self, **kw):
        vsm = _stub_vsm(id='1234')
        vsm.update(kw['body']['vsm'])
        return (200, {}, {'vsm': vsm})

    def get_vsms(self, **kw):
        return (200, {}, {"vsms": [
            {'id': 1234, 'name': 'sample-vsm'},
            {'id': 5678, 'name': 'sample-vsm2'}
        ]})

    # TODO(jdg): This will need to change
    # at the very least it's not complete
    def get_vsms_detail(self, **kw):
        return (200, {}, {"vsms": [
            {'id': 1234,
             'name': 'sample-vsm',
    ...
    def get_vsms_1234(self, **kw):
        r = {'vsm': self.get_vsms_detail()[2]['vsms'][0]}
        return (200, {}, r)

    def post_vsms_1234_action(self, body, **kw):
        _body = None
        resp = 202
    ...
    def post_vsms(self, **kw):
        return (202, {}, {'vsm': {}})

    def delete_vsms_1234(self, **kw):
        return (202, {}, None)
    ...
    def get_types_1(self, **kw):
        return (200, {}, {'vsm_type': {'id': 1,
                          'name': 'test-type-1',
                          'extra_specs': {}}})

    def post_types(self, body, **kw):
        return (202, {}, {'vsm_type': {'id': 3,
                          'name': 'test-type-3',
                          'extra_specs': {}}})
    ...
    # Set/Unset metadata
    #
    def delete_vsms_1234_metadata_test_key(self, **kw):
        return (204, {}, None)

    def delete_vsms_1234_metadata_key1(self, **kw):
        return (204, {}, None)

    def delete_vsms_1234_metadata_key2(self, **kw):
        return (204, {}, None)

    def post_vsms_1234_metadata(self, **kw):
