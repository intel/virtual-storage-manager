...
from vsmclient import service_catalog
        ...
        "serviceCatalog": [
            ...
            },
            {
                ...
                "endpoints": [
                    {
                        "tenantId": "1",
                        "publicURL": "https://vsm1.host/v1/1234",
                        "internalURL": "https://vsm1.host/v1/1234",
                        "region": "South",
                        "versionId": "1.0",
                        "versionInfo": "uri",
                        "versionList": "uri"
                    ...
                    {
                        "tenantId": "2",
                        "publicURL": "https://vsm1.host/v1/3456",
                        "internalURL": "https://vsm1.host/v1/3456",
                        "region": "South",
                        "versionId": "1.1",
                        "versionInfo": "https://vsm1.host/v1/",
                        "versionList": "https://vsm1.host/"
                    },
                ],
                "endpoints_links": [
                    {
...
class ServiceCatalogTest(utils.TestCase):
    ...
    def test_alternate_service_type(self):
        ...
        self.assertRaises(exceptions.AmbiguousEndpoints, sc.url_for,
                          service_type='vsm')
        self.assertEquals(sc.url_for('tenantId', '1', service_type='vsm'),
                          "https://vsm1.host/v1/1234")
        self.assertEquals(sc.url_for('tenantId', '2', service_type='vsm'),
                          "https://vsm1.host/v1/3456")

        self.assertRaises(exceptions.EndpointNotFound, sc.url_for,
                          "region", "North", service_type='vsm')
